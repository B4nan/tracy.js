...
class Tracy {
  ...
  constructor() {
    ...
    this.htmlResponseEnabled = false;
  }
   ...
   * @returns {Boolean}
   */
  isHtmlResponseEnabled() {
    return this.htmlResponseEnabled;
  }
  ...
  errorResponse(req, res, err = {}) {
    ...
    } else if (browser && this.isHtmlResponseEnabled()) { // tracy like json response when request accepts text/html
